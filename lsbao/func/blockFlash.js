...
function init(embed,isSilverLight){
	console.log(embed, isSilverLight);

	console.log(embed.$discovered);
	console.log(embed.$hidden);
	console.log(embed.$index);
