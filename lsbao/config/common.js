...
var _t = {
    ...
    write_rand_msec_start: 0,//500 //字符输入间隔
    write_rand_msec_end: 0,//1000 //字符输入间隔

    main_product_wait_rand_time_start: 1*60,//3*60 //主商品停留时间
    main_product_wait_rand_time_end: 2*60,//5*60 //主商品停留时间

    mainProductWaitRandTimeEndMin: 2*60, //2*60 主商品停留结束时间最大值随机的最小值
    mainProductWaitRandTimeEndMax: 10*60, //10*60 主商品停留结束时间最大值随机的最大值

    aux_product_wait_rand_time_start: 10, //1*60 //副商品停留时间
    aux_product_wait_rand_time_end: 30, //3*60 //副商品停留时间
